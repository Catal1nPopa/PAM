...
class CategorySection extends StatelessWidget {
  ...
  final RxList<CarouselEntity> carouselData; // Carousel data
  final RxList<WinesEntity> wineData; // Wine data
  ...
  Map<String, List<Map<String, dynamic>>> _buildDataMap() {
    ...
    // Convert Carousel data to List for iteration
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      // Build the filtered data map dynamically
